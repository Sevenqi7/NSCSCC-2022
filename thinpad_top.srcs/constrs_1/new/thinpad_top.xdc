...
# Add by ANJF: 2表示输入延迟和输出延迟都是2ns，这取决于电路板，在此仅仅是一个估计值，可以适当调整
set_input_delay -clock clk_50M 2.000 [get_ports {base_ram_data[*]}]
set_input_delay -clock clk_50M 2.000 [get_ports {ext_ram_data[*]}]
set_input_delay -clock clk_50M 2.000 [get_ports reset_btn]
set_input_delay -clock clk_50M 2.000 [get_ports rxd]
set_output_delay -clock clk_50M 2.000 [get_ports {base_ram_addr[*]}]
set_output_delay -clock clk_50M 2.000 [get_ports {base_ram_be_n[*]}]
set_output_delay -clock clk_50M 2.000 [get_ports {base_ram_data[*]}]
set_output_delay -clock clk_50M 2.000 [get_ports base_ram_oe_n]
set_output_delay -clock clk_50M 2.000 [get_ports base_ram_we_n]
set_output_delay -clock clk_50M 2.000 [get_ports {ext_ram_addr[*]}]
set_output_delay -clock clk_50M 2.000 [get_ports {ext_ram_be_n[*]}]
set_output_delay -clock clk_50M 2.000 [get_ports {ext_ram_data[*]}]
set_output_delay -clock clk_50M 2.000 [get_ports ext_ram_oe_n]
set_output_delay -clock clk_50M 2.000 [get_ports ext_ram_we_n]
set_output_delay -clock clk_50M 2.000 [get_ports txd]
set_output_delay -clock clk_50M 2.000 [get_ports {leds[*]}]
